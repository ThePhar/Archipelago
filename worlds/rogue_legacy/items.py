...
rl_items_data: dict[str, ItemData] = {
    # Classes
    "class_knight":     ItemData("Knights",                ItemClassification.useful),
    "class_mage":       ItemData("Mages",                  ItemClassification.useful),
    "class_barbarian":  ItemData("Barbarians",             ItemClassification.useful),
    "class_knave":      ItemData("Knaves",                 ItemClassification.useful),
    "class_shinobi":    ItemData("Shinobi",                ItemClassification.useful),
    "class_miner":      ItemData("Miners",                 ItemClassification.useful),
    "class_lich":       ItemData("Liches",                 ItemClassification.useful),
    "class_spellthief": ItemData("Spellthieves",           ItemClassification.useful),
    ...
    # Spells
    "spell_dagger":     ItemData("Daggers",                 ItemClassification.progression),
    "spell_axe":        ItemData("Axes",                    ItemClassification.progression),
    "spell_time_stop":  ItemData("Time Stop",               ItemClassification.filler),
    "spell_crow_storm": ItemData("Crow Storm",              ItemClassification.progression),
    "spell_trans":      ItemData("Quantum Translocator",    ItemClassification.filler),
    "spell_chakram":    ItemData("Chakrams",                ItemClassification.useful),
    "spell_scythe":     ItemData("Scythes",                 ItemClassification.progression),
    "spell_blade_wall": ItemData("Blade Wall",              ItemClassification.filler),
    "spell_flame_wall": ItemData("Flame Barrier",           ItemClassification.useful),
    "spell_conflux":    ItemData("Conflux",                 ItemClassification.filler),

    # Misc. Key Items
    "fountain_piece":   ItemData("Fountain Piece",         ItemClassification.progression_skip_balancing),
    "cap_level":        ItemData("Unlocked Potential",     ItemClassification.progression),
    "cap_architect":    ItemData("Architect Discount",     ItemClassification.useful),
    "cap_child":        ItemData("Child",                  ItemClassification.useful),
